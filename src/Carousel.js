...
const images = [
    ...
    "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTw1Ac86JVPuxgKaJ5YlRkOSz4xeY5S8SWYbg&usqp=CAU",
  ...
  class Carousel extends React.Component {
    ...
    componentDidMount() {
      let dataURL =
        "https://modus-services-testing.azurewebsites.net/demo/people";
      fetch(dataURL)
        .then((res) => res.json())
        .then((res) => {
          this.setState({
          ...
          if(this.state.edit===true){
            ...
            <form>
                    ...
                    <form>
                      ...
                      <input type="TEXT" defaultValue={item.gender} />
                    </form>
                    <hr />
                    <form>
                      <label>
                      ...
                      <input type="TEXT" defaultValue={item.birthday} />
                    </form>
                    <hr />
                    <form>
                      <label>
                      ...
                      <input type="TEXT" defaultValue={item.height} />
                    </form>
